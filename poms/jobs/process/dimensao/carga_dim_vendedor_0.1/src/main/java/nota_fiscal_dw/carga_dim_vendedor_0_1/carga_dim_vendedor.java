...
package nota_fiscal_dw.carga_dim_vendedor_0_1;
...
/**
 * Job: carga_dim_vendedor Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class carga_dim_vendedor implements TalendJob {
...
public String getBanco_dados_Port(){
	...
	private final String jobName = "carga_dim_vendedor";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				carga_dim_vendedor.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(carga_dim_vendedor.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
String dbUser_tCreateTable_1=context.banco_dados_Login;
        ...
        String tableName_tCreateTable_1 = "DIM_VENDEDOR";
...
java.sql.Connection conn_tCreateTable_1= java.sql.DriverManager.getConnection(url_tCreateTable_1,dbUser_tCreateTable_1, decryptedPassword_tCreateTable_1);
            ...
            boolean whetherExist_tCreateTable_1 = false;
                    ...
                    while(rsTable_tCreateTable_1.next()) {
                        ...
                        if(table_tCreateTable_1.equals("DIM_VENDEDOR") 
            ...
            rsTable_tCreateTable_1.close();
                if(!whetherExist_tCreateTable_1) {
                    ...
                    stmt_tCreateTable_1.execute("CREATE TABLE \"" + tableName_tCreateTable_1 + "\"(\"SK_VENDEDOR\" INT4 ,\"COD_VENDEDOR\" VARCHAR(10)  ,\"DES_VENDEDOR\" VARCHAR(200)  ,primary key(\"SK_VENDEDOR\"))");                
...
conn_tCreateTable_1.close();
        ...
        globalMap.put("tCreateTable_1_QUERY", "CREATE TABLE \"" + tableName_tCreateTable_1 + "\"(\"SK_VENDEDOR\" INT4 ,\"COD_VENDEDOR\" VARCHAR(10)  ,\"DES_VENDEDOR\" VARCHAR(200)  ,primary key(\"SK_VENDEDOR\"))");        
    } catch(java.lang.Exception e) {
...
public static class saida_vendedorStruct implements routines.system.IPersistableRow<saida_vendedorStruct> {
    final static byte[] commonByteArrayLock_NOTA_FISCAL_DW_carga_dim_vendedor = new byte[0];
    static byte[] commonByteArray_NOTA_FISCAL_DW_carga_dim_vendedor = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_NOTA_FISCAL_DW_carga_dim_vendedor.length) {
				if(length < 1024 && commonByteArray_NOTA_FISCAL_DW_carga_dim_vendedor.length == 0) {
   					commonByteArray_NOTA_FISCAL_DW_carga_dim_vendedor = new byte[1024];
				} else {
   					commonByteArray_NOTA_FISCAL_DW_carga_dim_vendedor = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_NOTA_FISCAL_DW_carga_dim_vendedor, 0, length);
			strReturn = new String(commonByteArray_NOTA_FISCAL_DW_carga_dim_vendedor, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_NOTA_FISCAL_DW_carga_dim_vendedor) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DES_VENDEDOR = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DES_VENDEDOR,dos);
     ...
     * Compare keys
     */
    public int compareTo(saida_vendedorStruct other) {
...
public static class STG_VENDEDORStruct implements routines.system.IPersistableRow<STG_VENDEDORStruct> {
    final static byte[] commonByteArrayLock_NOTA_FISCAL_DW_carga_dim_vendedor = new byte[0];
    static byte[] commonByteArray_NOTA_FISCAL_DW_carga_dim_vendedor = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(STG_VENDEDORStruct other) {
...
public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		STG_VENDEDORStruct STG_VENDEDOR = new STG_VENDEDORStruct();
saida_vendedorStruct saida_vendedor = new saida_vendedorStruct();
	...
	currentComponent="tDBSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("saida_vendedor" + iterateId, 0, 0);
...
public int hashCode() {
if(hashCodeDirty) {
int prime = 31;hashCode = prime * hashCode + (COD_VENDEDOR == null ? 0 : COD_VENDEDOR.hashCode());
hashCodeDirty = false;
}
return hashCode;
}
...
private String DES_VENDEDOR;
    ...
    if(dbSchema_tDBSCD_1 == null || dbSchema_tDBSCD_1.trim().length() == 0) {
        tableName_tDBSCD_1 = "DIM_VENDEDOR";
    } else {
        tableName_tDBSCD_1 = dbSchema_tDBSCD_1 + "\".\"" + "DIM_VENDEDOR";
    }
    java.sql.Timestamp timestamp_tDBSCD_1 = null;
    String tmpValue_tDBSCD_1 = null;    
        String search_tDBSCD_1 = "SELECT \"COD_VENDEDOR\", \"DES_VENDEDOR\" FROM \"" + tableName_tDBSCD_1 + "\"";
        ...
        while(resultSet_tDBSCD_1.next()) {
            ...
            SCDStruct_tDBSCD_1 row_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    if(resultSet_tDBSCD_1.getObject(1) != null) {
                        sk_tDBSCD_1.COD_VENDEDOR = resultSet_tDBSCD_1.getString(1);
                    }
                    if(resultSet_tDBSCD_1.getObject(2) != null) {
                        row_tDBSCD_1.DES_VENDEDOR = resultSet_tDBSCD_1.getString(2);
                    }
        ...
        String tmpQuery_tDBSCD_1 = "SELECT MAX(\"SK_VENDEDOR\") FROM \"" + tableName_tDBSCD_1 + "\"";
    ...
    String insertionSQL_tDBSCD_1 = "INSERT INTO \"" + tableName_tDBSCD_1 + "\"(\"SK_VENDEDOR\", \"COD_VENDEDOR\", \"DES_VENDEDOR\") VALUES(?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tDBSCD_1 = connection_tDBSCD_1.prepareStatement(insertionSQL_tDBSCD_1);
        String updateSQLForType1_tDBSCD_1 = "UPDATE \"" + tableName_tDBSCD_1 + "\" SET \"DES_VENDEDOR\" = ? WHERE \"COD_VENDEDOR\" = ?";
	...
	currentComponent="tMap_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("STG_VENDEDOR" + iterateId, 0, 0);
...
saida_vendedorStruct saida_vendedor_tmp = new saida_vendedorStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.banco_dados_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  \""+context.banco_dados_Database+"\".\""+context.banco_dados_Schema+"\".\"STG_VENDEDOR\".\"cod_vendedor\", \n  \""+context.banco_dados_Database+"\".\""+context.banco_dados_Schema+"\".\"STG_VENDEDOR\".\"des_vendedor\"\nFROM \""+context.banco_dados_Database+"\".\""+context.banco_dados_Schema+"\".\"STG_VENDEDOR\"";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								STG_VENDEDOR.cod_vendedor = null;
							} else {
	                         		
        	STG_VENDEDOR.cod_vendedor = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								STG_VENDEDOR.des_vendedor = null;
							} else {
	                         		
        	STG_VENDEDOR.des_vendedor = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tMap_1";
			...
			//STG_VENDEDOR
				...
				if(execStat){
					runStat.updateStatOnConnection("STG_VENDEDOR"+iterateId,1, 1);
				} 
...
// # Output table : 'saida_vendedor'
saida_vendedor_tmp.COD_VENDEDOR = STG_VENDEDOR.cod_vendedor ;
saida_vendedor_tmp.DES_VENDEDOR = STG_VENDEDOR.des_vendedor ;
saida_vendedor = saida_vendedor_tmp;
// ###############################
 ...
 */
// Start of branch "saida_vendedor"
if(saida_vendedor != null) { 
	...
	currentComponent="tDBSCD_1";
			...
			//saida_vendedor
				...
				if(execStat){
					runStat.updateStatOnConnection("saida_vendedor"+iterateId,1, 1);
				} 
 	...
 	try {
        lookUpKey_tDBSCD_1 = new SCDSK_tDBSCD_1();
            lookUpKey_tDBSCD_1.COD_VENDEDOR = saida_vendedor.COD_VENDEDOR;
    ...
    if(lookUpValue_tDBSCD_1 == null) {
            lookUpValue_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    ...
                    if(saida_vendedor.COD_VENDEDOR == null) {
insertionStatement_tDBSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(2, saida_vendedor.COD_VENDEDOR);
}

                    if(saida_vendedor.DES_VENDEDOR == null) {
insertionStatement_tDBSCD_1.setNull(3, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(3, saida_vendedor.DES_VENDEDOR);
}

        nb_line_inserted_tDBSCD_1 += insertionStatement_tDBSCD_1.executeUpdate();
    } else {
            if((lookUpValue_tDBSCD_1.DES_VENDEDOR == null && saida_vendedor.DES_VENDEDOR!= null) || (lookUpValue_tDBSCD_1.DES_VENDEDOR != null && !lookUpValue_tDBSCD_1.DES_VENDEDOR.equals(saida_vendedor.DES_VENDEDOR))) {
                    if(saida_vendedor.DES_VENDEDOR == null) {
updateForType1_tDBSCD_1.setNull(1, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(1, saida_vendedor.DES_VENDEDOR);
}

                    if(saida_vendedor.COD_VENDEDOR == null) {
updateForType1_tDBSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(2, saida_vendedor.COD_VENDEDOR);
}
                ...
                lookUpValue_tDBSCD_1.DES_VENDEDOR = saida_vendedor.DES_VENDEDOR;
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("STG_VENDEDOR"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    globalMap.put("tDBSCD_1_NB_LINE_REJECTED",nb_line_rejected_tDBSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("saida_vendedor"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final carga_dim_vendedor carga_dim_vendedorClass = new carga_dim_vendedor();

        int exitCode = carga_dim_vendedorClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = carga_dim_vendedor.class.getClassLoader().getResourceAsStream("nota_fiscal_dw/carga_dim_vendedor_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = carga_dim_vendedor.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : carga_dim_vendedor");
        }
...
/************************************************************************************************
 *     61163 characters generated by Talend Open Studio for Data Integration 
 *     on the 10 de Maio de 2019 16h30min43s BRT
 ************************************************************************************************/