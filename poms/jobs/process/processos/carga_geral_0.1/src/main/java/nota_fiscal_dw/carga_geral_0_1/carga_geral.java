...
package nota_fiscal_dw.carga_geral_0_1;
...
/**
 * Job: carga_geral Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class carga_geral implements TalendJob {
	...
	private final String jobName = "carga_geral";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(carga_geral.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				nota_fiscal_dw.carrega_stages_0_1.carrega_stages childJob_tRunJob_1 = new nota_fiscal_dw.carrega_stages_0_1.carrega_stages();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				nota_fiscal_dw.carrega_dimensoes_0_1.carrega_dimensoes childJob_tRunJob_2 = new nota_fiscal_dw.carrega_dimensoes_0_1.carrega_dimensoes();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				nota_fiscal_dw.carga_fato_venda_0_1.carga_fato_venda childJob_tRunJob_3 = new nota_fiscal_dw.carga_fato_venda_0_1.carga_fato_venda();
				// pass DataSources
	...
	public static void main(String[] args) {
		final carga_geral carga_geralClass = new carga_geral();

		int exitCode = carga_geralClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = carga_geral.class.getClassLoader()
					.getResourceAsStream(
							"nota_fiscal_dw/carga_geral_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = carga_geral.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : carga_geral");
		}
...
/************************************************************************************************
 * 44630 characters generated by Talend Open Studio for Data Integration on the
 * 10 de Maio de 2019 16h30min44s BRT
 ************************************************************************************************/
