...
package nota_fiscal_dw.carrega_dimensoes_0_1;
...
/**
 * Job: carrega_dimensoes Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class carrega_dimensoes implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "carrega_dimensoes";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				carrega_dimensoes.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(carrega_dimensoes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		nota_fiscal_dw.carga_dim_departamento_0_1.carga_dim_departamento childJob_tRunJob_1 = new nota_fiscal_dw.carga_dim_departamento_0_1.carga_dim_departamento();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		nota_fiscal_dw.carga_dim_produto_0_1.carga_dim_produto childJob_tRunJob_3 = new nota_fiscal_dw.carga_dim_produto_0_1.carga_dim_produto();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		nota_fiscal_dw.carga_dim_vendedor_0_1.carga_dim_vendedor childJob_tRunJob_6 = new nota_fiscal_dw.carga_dim_vendedor_0_1.carga_dim_vendedor();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final carrega_dimensoes carrega_dimensoesClass = new carrega_dimensoes();

        int exitCode = carrega_dimensoesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = carrega_dimensoes.class.getClassLoader().getResourceAsStream("nota_fiscal_dw/carrega_dimensoes_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = carrega_dimensoes.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : carrega_dimensoes");
        }
...
/************************************************************************************************
 *     40991 characters generated by Talend Open Studio for Data Integration 
