...
package nota_fiscal_dw.carrega_stages_0_1;
...
/**
 * Job: carrega_stages Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class carrega_stages implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "carrega_stages";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				carrega_stages.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(carrega_stages.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		nota_fiscal_dw.carga_departamento_0_1.carga_departamento childJob_tRunJob_1 = new nota_fiscal_dw.carga_departamento_0_1.carga_departamento();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		nota_fiscal_dw.carga_produto_0_1.carga_produto childJob_tRunJob_3 = new nota_fiscal_dw.carga_produto_0_1.carga_produto();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		nota_fiscal_dw.carga_vendedor_0_1.carga_vendedor childJob_tRunJob_10 = new nota_fiscal_dw.carga_vendedor_0_1.carga_vendedor();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_10 = childJob_tRunJob_10.runJob((String[]) paraList_tRunJob_10.toArray(new String[paraList_tRunJob_10.size()]));
		    ...
		    if (childJob_tRunJob_10.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_10.getErrorCode() != null || ("failure").equals(childJob_tRunJob_10.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_10.getException().getClass().getName() + ": " + childJob_tRunJob_10.getException().getMessage());
				}
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		nota_fiscal_dw.garrega_fatos_0_1.garrega_fatos childJob_tRunJob_6 = new nota_fiscal_dw.garrega_fatos_0_1.garrega_fatos();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final carrega_stages carrega_stagesClass = new carrega_stages();

        int exitCode = carrega_stagesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = carrega_stages.class.getClassLoader().getResourceAsStream("nota_fiscal_dw/carrega_stages_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = carrega_stages.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : carrega_stages");
        }
...
/************************************************************************************************
 *     47875 characters generated by Talend Open Studio for Data Integration 
