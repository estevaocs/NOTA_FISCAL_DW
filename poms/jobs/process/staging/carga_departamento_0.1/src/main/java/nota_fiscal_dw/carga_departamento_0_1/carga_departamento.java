...
package nota_fiscal_dw.carga_departamento_0_1;
...
/**
 * Job: carga_departamento Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class carga_departamento implements TalendJob {
...
public String getBanco_dados_Port(){
	...
	private final String jobName = "carga_departamento";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				carga_departamento.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(carga_departamento.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_departamentoStruct implements routines.system.IPersistableRow<saida_departamentoStruct> {
    final static byte[] commonByteArrayLock_NOTA_FISCAL_DW_carga_departamento = new byte[0];
    static byte[] commonByteArray_NOTA_FISCAL_DW_carga_departamento = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_NOTA_FISCAL_DW_carga_departamento.length) {
				if(length < 1024 && commonByteArray_NOTA_FISCAL_DW_carga_departamento.length == 0) {
   					commonByteArray_NOTA_FISCAL_DW_carga_departamento = new byte[1024];
				} else {
   					commonByteArray_NOTA_FISCAL_DW_carga_departamento = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_NOTA_FISCAL_DW_carga_departamento, 0, length);
			strReturn = new String(commonByteArray_NOTA_FISCAL_DW_carga_departamento, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_NOTA_FISCAL_DW_carga_departamento) {
...
public static class departamento_metadadosStruct implements routines.system.IPersistableRow<departamento_metadadosStruct> {
    final static byte[] commonByteArrayLock_NOTA_FISCAL_DW_carga_departamento = new byte[0];
    static byte[] commonByteArray_NOTA_FISCAL_DW_carga_departamento = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(departamento_metadadosStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		departamento_metadadosStruct departamento_metadados = new departamento_metadadosStruct();
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = "STG_DEPARTAMENTO";
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + "STG_DEPARTAMENTO";
}
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"COD_DEPARTAMENTO\",\"DES_DEPARTAMENTO\") VALUES (?,?)";
	...
	currentComponent="tMap_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("departamento_metadados" + iterateId, 0, 0);
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Departamento", false));
...
//end%>
			...
			departamento_metadados = new departamento_metadadosStruct();
			...
			departamento_metadados.cod_departamento = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else {
				departamento_metadados.cod_departamento = null;
			...
			departamento_metadados.Departamento = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else {
				departamento_metadados.Departamento = null;
				emptyColumnCount_tFileInputExcel_1++;
		}
 ...
 */
// Start of branch "departamento_metadados"
if(departamento_metadados != null) { 
	...
	currentComponent="tMap_1";
			...
			//departamento_metadados
			//departamento_metadados


			
				if(execStat){
					runStat.updateStatOnConnection("departamento_metadados"+iterateId,1, 1);
				} 
...
saida_departamento_tmp.COD_DEPARTAMENTO = departamento_metadados.cod_departamento ;
saida_departamento_tmp.DES_DEPARTAMENTO = StringHandling.UPCASE(departamento_metadados.Departamento) ;
...
} else {pstmt_tDBOutput_1.setString(1, saida_departamento.COD_DEPARTAMENTO);
}

                    if(saida_departamento.DES_DEPARTAMENTO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, saida_departamento.DES_DEPARTAMENTO);
}
...
} // End of branch "departamento_metadados"
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("departamento_metadados"+iterateId,2, 0); 
			 	}
			}
...
String dbUser_tCreateTable_1=context.banco_dados_Login;
        ...
        String tableName_tCreateTable_1 = "STG_DEPARTAMENTO";
...
java.sql.Connection conn_tCreateTable_1= java.sql.DriverManager.getConnection(url_tCreateTable_1,dbUser_tCreateTable_1, decryptedPassword_tCreateTable_1);
            ...
            boolean whetherExist_tCreateTable_1 = false;
                    ...
                    while(rsTable_tCreateTable_1.next()) {
                        ...
                        if(table_tCreateTable_1.equals("STG_DEPARTAMENTO") 
            ...
            rsTable_tCreateTable_1.close();
                if(!whetherExist_tCreateTable_1) {
                    ...
                    stmt_tCreateTable_1.execute("CREATE TABLE \"" + tableName_tCreateTable_1 + "\"(\"COD_DEPARTAMENTO\" VARCHAR(10)   not null ,\"DES_DEPARTAMENTO\" VARCHAR(200)  ,primary key(\"COD_DEPARTAMENTO\"))");                
...
conn_tCreateTable_1.close();
        ...
        globalMap.put("tCreateTable_1_QUERY", "CREATE TABLE \"" + tableName_tCreateTable_1 + "\"(\"COD_DEPARTAMENTO\" VARCHAR(10)   not null ,\"DES_DEPARTAMENTO\" VARCHAR(200)  ,primary key(\"COD_DEPARTAMENTO\"))");        
    } catch(java.lang.Exception e) {
 ...
 */
    ...
    public static void main(String[] args){
        final carga_departamento carga_departamentoClass = new carga_departamento();

        int exitCode = carga_departamentoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = carga_departamento.class.getClassLoader().getResourceAsStream("nota_fiscal_dw/carga_departamento_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = carga_departamento.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : carga_departamento");
        }
...
/************************************************************************************************
 *     73840 characters generated by Talend Open Studio for Data Integration 
