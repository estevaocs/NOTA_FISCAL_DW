...
package nota_fiscal_dw.carga_produto_0_1;
...
/**
 * Job: carga_produto Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class carga_produto implements TalendJob {
...
public String getBanco_dados_Port(){
	...
	private final String jobName = "carga_produto";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				carga_produto.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(carga_produto.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_produtoStruct implements routines.system.IPersistableRow<saida_produtoStruct> {
    final static byte[] commonByteArrayLock_NOTA_FISCAL_DW_carga_produto = new byte[0];
    static byte[] commonByteArray_NOTA_FISCAL_DW_carga_produto = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final saida_produtoStruct other = (saida_produtoStruct) obj;
	...
	public void copyDataTo(saida_produtoStruct other) {

		other.cod_produto = this.cod_produto;
	            other.nom_produto = this.nom_produto;
	            
	}

	public void copyKeysDataTo(saida_produtoStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_NOTA_FISCAL_DW_carga_produto.length) {
				if(length < 1024 && commonByteArray_NOTA_FISCAL_DW_carga_produto.length == 0) {
   					commonByteArray_NOTA_FISCAL_DW_carga_produto = new byte[1024];
				} else {
   					commonByteArray_NOTA_FISCAL_DW_carga_produto = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_NOTA_FISCAL_DW_carga_produto, 0, length);
			strReturn = new String(commonByteArray_NOTA_FISCAL_DW_carga_produto, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_NOTA_FISCAL_DW_carga_produto) {
...
public static class produto_metadadosStruct implements routines.system.IPersistableRow<produto_metadadosStruct> {
    final static byte[] commonByteArrayLock_NOTA_FISCAL_DW_carga_produto = new byte[0];
    static byte[] commonByteArray_NOTA_FISCAL_DW_carga_produto = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(produto_metadadosStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		produto_metadadosStruct produto_metadados = new produto_metadadosStruct();
	...
	currentComponent="tDBOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("saida_produto" + iterateId, 0, 0);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = "STG_PRODUTO";
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + "STG_PRODUTO";
}
...
int count_tDBOutput_1=0;
	    ...
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"nom_produto\" = ? WHERE \"cod_produto\" = ?";
	...
	currentComponent="tMap_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("produto_metadados" + iterateId, 0, 0);
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "produto", false));
...
//end%>
			...
			produto_metadados = new produto_metadadosStruct();
			...
			produto_metadados.cod_produto = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
			}else {
				produto_metadados.cod_produto = null;
			...
			produto_metadados.nom_produto = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
			}else {
				produto_metadados.nom_produto = null;
				emptyColumnCount_tFileInputExcel_1++;
		}
 ...
 */
// Start of branch "produto_metadados"
if(produto_metadados != null) { 
	...
	currentComponent="tMap_1";
			...
			//produto_metadados
				...
				if(execStat){
					runStat.updateStatOnConnection("produto_metadados"+iterateId,1, 1);
				} 
...
saida_produto_tmp.cod_produto = produto_metadados.cod_produto ;
saida_produto_tmp.nom_produto = StringHandling.UPCASE(produto_metadados.nom_produto) ;
...
if(saida_produto != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			//saida_produto
				...
				if(execStat){
					runStat.updateStatOnConnection("saida_produto"+iterateId,1, 1);
				} 
        ...
        whetherReject_tDBOutput_1 = false;
                    if(saida_produto.nom_produto == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, saida_produto.nom_produto);
}

                    if(saida_produto.cod_produto == null) {
pstmt_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2 + count_tDBOutput_1, saida_produto.cod_produto);
}
...
} // End of branch "produto_metadados"
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("produto_metadados"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("saida_produto"+iterateId,2, 0); 
			 	}
			}
...
String dbUser_tCreateTable_1=context.banco_dados_Login;
        ...
        String tableName_tCreateTable_1 = "STG_PRODUTO";
...
java.sql.Connection conn_tCreateTable_1= java.sql.DriverManager.getConnection(url_tCreateTable_1,dbUser_tCreateTable_1, decryptedPassword_tCreateTable_1);
            ...
            boolean whetherExist_tCreateTable_1 = false;
                    ...
                    while(rsTable_tCreateTable_1.next()) {
                        ...
                        if(table_tCreateTable_1.equals("STG_PRODUTO") 
            ...
            rsTable_tCreateTable_1.close();
                if(!whetherExist_tCreateTable_1) {
                    ...
                    stmt_tCreateTable_1.execute("CREATE TABLE \"" + tableName_tCreateTable_1 + "\"(\"cod_produto\" VARCHAR(10)  ,\"nom_produto\" VARCHAR(200)  ,primary key(\"cod_produto\"))");                
...
conn_tCreateTable_1.close();
        ...
        globalMap.put("tCreateTable_1_QUERY", "CREATE TABLE \"" + tableName_tCreateTable_1 + "\"(\"cod_produto\" VARCHAR(10)  ,\"nom_produto\" VARCHAR(200)  ,primary key(\"cod_produto\"))");        
    } catch(java.lang.Exception e) {
 ...
 */
    ...
    public static void main(String[] args){
        final carga_produto carga_produtoClass = new carga_produto();

        int exitCode = carga_produtoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = carga_produto.class.getClassLoader().getResourceAsStream("nota_fiscal_dw/carga_produto_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = carga_produto.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : carga_produto");
        }
...
/************************************************************************************************
 *     73315 characters generated by Talend Open Studio for Data Integration 
