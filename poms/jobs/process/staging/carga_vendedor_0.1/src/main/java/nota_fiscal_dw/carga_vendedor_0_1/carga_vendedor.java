...
package nota_fiscal_dw.carga_vendedor_0_1;
...
/**
 * Job: carga_vendedor Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class carga_vendedor implements TalendJob {
...
public String getBanco_dados_Port(){
	...
	private final String jobName = "carga_vendedor";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				carga_vendedor.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(carga_vendedor.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_vendedorStruct implements routines.system.IPersistableRow<saida_vendedorStruct> {
    final static byte[] commonByteArrayLock_NOTA_FISCAL_DW_carga_vendedor = new byte[0];
    static byte[] commonByteArray_NOTA_FISCAL_DW_carga_vendedor = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_NOTA_FISCAL_DW_carga_vendedor.length) {
				if(length < 1024 && commonByteArray_NOTA_FISCAL_DW_carga_vendedor.length == 0) {
   					commonByteArray_NOTA_FISCAL_DW_carga_vendedor = new byte[1024];
				} else {
   					commonByteArray_NOTA_FISCAL_DW_carga_vendedor = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_NOTA_FISCAL_DW_carga_vendedor, 0, length);
			strReturn = new String(commonByteArray_NOTA_FISCAL_DW_carga_vendedor, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_NOTA_FISCAL_DW_carga_vendedor) {
...
public static class vendedor_metadadosStruct implements routines.system.IPersistableRow<vendedor_metadadosStruct> {
    final static byte[] commonByteArrayLock_NOTA_FISCAL_DW_carga_vendedor = new byte[0];
    static byte[] commonByteArray_NOTA_FISCAL_DW_carga_vendedor = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(vendedor_metadadosStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		vendedor_metadadosStruct vendedor_metadados = new vendedor_metadadosStruct();
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = "STG_VENDEDOR";
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + "STG_VENDEDOR";
}
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"cod_vendedor\",\"des_vendedor\") VALUES (?,?)";
	...
	currentComponent="tMap_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("vendedor_metadados" + iterateId, 0, 0);
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "vendedor", false));
...
//end%>
			...
			vendedor_metadados = new vendedor_metadadosStruct();
			...
			vendedor_metadados.cod_vendedor = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else {
				vendedor_metadados.cod_vendedor = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "des_vendedor";
			vendedor_metadados.des_vendedor = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else {
				vendedor_metadados.des_vendedor = null;
				emptyColumnCount_tFileInputExcel_1++;
		}
 ...
 */
// Start of branch "vendedor_metadados"
if(vendedor_metadados != null) { 
	...
	currentComponent="tMap_1";
			...
			//vendedor_metadados
				...
				if(execStat){
					runStat.updateStatOnConnection("vendedor_metadados"+iterateId,1, 1);
				} 
...
saida_vendedor_tmp.cod_vendedor = vendedor_metadados.cod_vendedor ;
saida_vendedor_tmp.des_vendedor = StringHandling.UPCASE(vendedor_metadados.des_vendedor) ;
...
} else {pstmt_tDBOutput_1.setString(1, saida_vendedor.cod_vendedor);
}

                    if(saida_vendedor.des_vendedor == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, saida_vendedor.des_vendedor);
}
...
} // End of branch "vendedor_metadados"
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("vendedor_metadados"+iterateId,2, 0); 
			 	}
			}
...
String dbUser_tCreateTable_1=context.banco_dados_Login;
        ...
        String tableName_tCreateTable_1 = "STG_VENDEDOR";
...
java.sql.Connection conn_tCreateTable_1= java.sql.DriverManager.getConnection(url_tCreateTable_1,dbUser_tCreateTable_1, decryptedPassword_tCreateTable_1);
            ...
            boolean whetherExist_tCreateTable_1 = false;
                    ...
                    while(rsTable_tCreateTable_1.next()) {
                        ...
                        if(table_tCreateTable_1.equals("STG_VENDEDOR") 
            ...
            rsTable_tCreateTable_1.close();
                if(!whetherExist_tCreateTable_1) {
                    ...
                    stmt_tCreateTable_1.execute("CREATE TABLE \"" + tableName_tCreateTable_1 + "\"(\"cod_vendedor\" VARCHAR(10)  ,\"des_vendedor\" VARCHAR(200)  ,primary key(\"cod_vendedor\"))");                
...
conn_tCreateTable_1.close();
        ...
        globalMap.put("tCreateTable_1_QUERY", "CREATE TABLE \"" + tableName_tCreateTable_1 + "\"(\"cod_vendedor\" VARCHAR(10)  ,\"des_vendedor\" VARCHAR(200)  ,primary key(\"cod_vendedor\"))");        
    } catch(java.lang.Exception e) {
 ...
 */
    ...
    public static void main(String[] args){
        final carga_vendedor carga_vendedorClass = new carga_vendedor();

        int exitCode = carga_vendedorClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = carga_vendedor.class.getClassLoader().getResourceAsStream("nota_fiscal_dw/carga_vendedor_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = carga_vendedor.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : carga_vendedor");
        }
...
/************************************************************************************************
 *     71753 characters generated by Talend Open Studio for Data Integration 
 *     on the 10 de Maio de 2019 16h30min40s BRT
 ************************************************************************************************/